...
function RulesDialog({ open, onClose }) {
  ...
  const slides = [
    {
      id: 0,
      title: 'Regla 1 — Menos golpes, mejor',
    ...
    {
      id: 1,
      title: 'Regla 2 — Fuera de pista (+3)',
    ...
    {
      id: 3,
      title: 'Regla 4 — Puntuación en la app',
      titleClass: 'title--how',
      bgClass: 'slide--four',
      text:
          ...
          <div ref={ref} className="keen-slider rulesDialogSlides" style={{ height: '100%' }}>
            {slides.map((slide) => (
              <div key={slide.id} className={`keen-slider__slide rulesDialogSlide ${slide.bgClass}`}>
                <h3 className={`rulesDialogTitle ${slide.titleClass}`}>{slide.title}</h3>
